...
builder.Services.AddCoreModulesOrder();
builder.Services.AddInfrastructureModulesOrder();
builder.Services.AddCoreModulesOrderDetails();
builder.Services.AddInfrastructureModulesOrderDetails();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("../swagger/v1/swagger.json", "Arepas.Api v1"));
}
